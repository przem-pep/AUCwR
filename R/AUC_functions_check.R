...
#fun <- function(p, t){Hmisc::somers2(-p, t)[1]}
...
# CHECK7 non-numeric pred; should be error (or 0.8541667)
...
# CHECK9a (NA target) should be 0.8055556 or error 
aucuf(fun, c(1, 1, 2, 3, 4, 4, 5, 5, 6, 7), c(1, 1, 1, 1, 0, 1, 0, 0, 1, NA)) 
# CHECK9b (NA pred) should be 0.8055556 or error
aucuf(fun, c(1, 1, 2, 3, 4, 4, 5, 5, 6, NA), c(1, 1, 1, 1, 0, 1, 0, 0, 1, 0)) 
