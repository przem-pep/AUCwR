...
Harrell et al. [Harrell et al, 1982] and further elaborated by, for example 
Austin and Steyerberg [Austin & Steyerberg, 2012], represents the probability 
...
the ***probability of superiority***, indicating the likelihood that a randomly 
...
***Common Language Effect Size*** (CL/CLES) [McGraw & Wong, 1992], which 
...
(denoted as $A$) [Vargha & Delaney, 2000] generalized CLES 
...
non-parametric analysis for longitudinal data, Brunner et al. [2002] define 
the ***relative treatment effect***. This metric estimates the probability that 
...
[Brunner et al., 2002; Engelmann et al., 2003].


**The Gini Coefficient and related measures**
