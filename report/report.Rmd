...
-   C-statistic [@Harrell_Califf]

-   a version of estimator of the common language effect size statistic

-   probability of superiority [@Hanley_McNeil_1982]
...
-   accuracy ratio based on the Cumulative Accuracy Profile [@Engelmann_Hayden_Tasche_2003]

-   a special case of the Somers' D statistic [@Newson_2002]
...
```{r}
tab1 <- gt(read.csv("../functions_table.csv", sep = ";")) |>
  tab_header(title = "Functions computing AUC")
