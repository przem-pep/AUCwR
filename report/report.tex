...
Harrell et al. \citep{Harrell_Califf_Pryor_Lee_Rosati_1982} and further elaborated by, for example
Austin and Steyerberg \citep{Austin_Steyerberg_2012}, represents the probability
...
\(Common Language Effect Size\) (CL/CLES) \citep{McGraw_Wong_1992}, which
...
{[}Brunner\_et\_al\_2002{]},{[}Engelmann\_et\_al\_2003{]}.
...
transformation of the AUC, defined by the relationship \citep{Hand_Till}:
...
\section{Uncertainty estimation and permutation tests}\label{uncertainty-estimation-and-permutation-tests}
...
\section{AUC Maximization Algorithms}\label{auc-maximization-algorithms}
...
\section{Simulation and curve modeling in credit risk}\label{simulation-and-curve-modeling-in-credit-risk}
...
\subsection{First benchmark - 1000 observations}\label{first-benchmark---1000-observations}

\includegraphics{report_files/figure-latex/unnamed-chunk-3-1.pdf}

\subsection{Second benchmark - 10000 observations}\label{second-benchmark---10000-observations}

\includegraphics{report_files/figure-latex/unnamed-chunk-4-1.pdf}

\subsection{Third benchmark - 100000 observations}\label{third-benchmark---100000-observations}
